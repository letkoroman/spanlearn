    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          messages: [{
            role: "user",
            content: `Si španielsky jazykový učiteľ. Dostaneš slovenské slovo a vrátiš JSON objekt (BEZ markdown, BEZ backticks) s týmito poľami:
